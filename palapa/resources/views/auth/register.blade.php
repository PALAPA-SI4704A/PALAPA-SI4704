        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-6">
            ...
            <div class="relative">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="users_name" placeholder="Nama Lengkap Kamu" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="relative" x-data="{ show: false }">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-blue-500 transition">
